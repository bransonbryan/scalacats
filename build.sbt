...
val gh = GitHubSettings(org = "com.branson.bryan", proj = "scalacats", publishOrg = "com.branson.bryan", license = apache2)
val devs = Seq(Dev("Bryan Branson", "@bransonbryan"))
...
mainClass in (Compile, run) := Some("com.branson.bryan.Main")
